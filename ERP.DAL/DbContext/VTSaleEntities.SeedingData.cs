...
END";
        ...
        public static void AddingPages(VTSaleEntities db, Guid roleID, Guid userId)
        {
            ...
            pages.Add(new Page() { Id = 48, ParentId = null, Icon = "icon-md fas fa-money-bill-alt ylow", IsPage = false, Name = "رصيد اول المدة", OrderNum = 2, Url = "", OtherUrls = null });
            pages.Add(new Page() { Id = 49, ParentId = null, Icon = "icon-md fas fa-sitemap ylow", IsPage = false, Name = "الأصناف", OrderNum = 3, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 62, ParentId = null, Icon = "icon-md fas fa-ship ylow", IsPage = false, Name = "توليف صنف", OrderNum = 4, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 79, ParentId = null, Icon = "icon-md fas fa-arrow-alt-circle-right ylow", IsPage = false, Name = "التوريدات", OrderNum = 10, Url = "", OtherUrls = null });
            pages.Add(new Page() { Id = 80, ParentId = null, Icon = "icon-md fas fa-undo-alt ylow", IsPage = false, Name = "مرتجع التوريدات", OrderNum = 11, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 88, ParentId = null, Icon = "icon-md fas fa-user-alt ylow", IsPage = false, Name = "العملاء", OrderNum = 5, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 103, ParentId = null, Icon = "icon-md fas fa-arrow-alt-circle-left ylow", IsPage = false, Name = "المبيعات", OrderNum = 8, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 110, ParentId = null, Icon = "icon-md fas fa-undo ylow", IsPage = false, Name = "مرتجع المبيعات", OrderNum = 9, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 117, ParentId = null, Icon = "icon-md fas fa-user-cog ylow", IsPage = false, Name = "اوامر الانتاج", OrderNum = 16, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 125, ParentId = null, Icon = "icon-md fas fa-warehouse ylow", IsPage = false, Name = "المخازن", OrderNum = 15, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 132, ParentId = null, Icon = "icon-md fas fa-download ylow", IsPage = false, Name = "مركز التحميل", OrderNum = 20, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 139, ParentId = null, Icon = "icon-md fas fa-users ylow", IsPage = false, Name = "الموارد البشرية", OrderNum = 18, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 196, ParentId = null, Icon = "icon-md fas fa-file-invoice-dollar ylow", IsPage = false, Name = "دليل الحسابات", OrderNum = 12, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 204, ParentId = null, Icon = "icon-md fas fa-users-cog ylow", IsPage = false, Name = "الصلاحيات والمستخدمين", OrderNum = 19, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 220, ParentId = null, Icon = "icon-md fas fa-file-signature ylow", IsPage = false, Name = "التقارير", OrderNum = 22, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 255, ParentId = null, Icon = "icon-md fas fa-user-tag ylow", IsPage = false, Name = "المناديب", OrderNum = 17, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 269, ParentId = null, Icon = "icon-md fas fa-cog ylow", IsPage = false, Name = "الصيانه", OrderNum = 23, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 277, ParentId = null, Icon = "icon-md fas fa-bell ylow", IsPage = false, Name = "الاشعارات", OrderNum = 24, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 332, ParentId = null, Icon = "icon-md fas fa-cog ylow", IsPage = false, Name = "التقسيط", OrderNum = 21, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 340, ParentId = null, Icon = "icon-md fas fa-coins ylow", IsPage = false, Name = "سندات الصرف والقبض", OrderNum = 13, Url = "", OtherUrls = null });
            ...
            pages.Add(new Page() { Id = 402, ParentId = null, Icon = "icon-md fas fa-coins ylow", IsPage = false, Name = "عروض الاسعار وأوامر البيع", OrderNum = 7, Url = "", OtherUrls = null });

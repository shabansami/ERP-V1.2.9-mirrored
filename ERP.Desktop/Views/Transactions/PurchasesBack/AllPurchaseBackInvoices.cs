...
{
    public partial class AllPurchaseBackInvoices : BaseForm
    {
        PurchaseBackServices _services;
        Guid shiftID;
        public PurchaseBackInvoice ReturnedInvoice;
        TypeAssistant assistant;
        public AllPurchaseBackInvoices(Guid shiftID, PurchaseBackServices saleServices)
        {
            InitializeComponent();

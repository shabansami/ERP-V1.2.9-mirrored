...
{
    public partial class AllSellBackInvoices : BaseForm
    {
        SaleBackServices _services;
        Guid shiftID;
        public SellBackInvoice ReturnedInvoice;
        TypeAssistant assistant;
        public AllSellBackInvoices(Guid shiftID, SaleBackServices saleServices)
        {
            InitializeComponent();

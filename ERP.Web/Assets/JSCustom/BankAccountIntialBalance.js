"use strict";
var BankAccountIntialBalance_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                ...
                {
                    extend: "excelHtml5",
                    filename: "رصيد اول المدة للبنوك",
                    title: "رصيد اول المدة للبنوك",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
            ...
            ajax: {
                url: '/BankAccountIntialBalances/GetAll',
                type: 'GET',

                    },
        columns: [
            { data: 'Num', responsivePriority: 0},
            { data: 'BankAccountName', title: 'اسم الحساب البنكى' },
...
//"order": [[0, "desc"]] 
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/BankAccountIntialBalances/Index" }, 3000);
                        }else
                            setTimeout(function () { window.location = "/BankAccountIntialBalances/CreateEdit" } , 3000);
    ...
    function deleteRow(id) {
        Swal.fire({
            ...
            if (result.value) {
                var url = '/BankAccountIntialBalances/Delete';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {

...
var ClosingPeriods_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            columns: [
                ...
                { data: 'StartDate', title: 'من' },
                { data: 'EndDate', title: 'إلي' },
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        return '\
							<div class="btn-group">\
							<a href="/ClosingPeriods/Edit/'+ row.Id + '" class="btn btn-sm btn-clean btn-icon" title="تعديل">\
								<i class="fa fa-edit"></i>\
							</a>\
							<a href="javascript:;" onclick=ClosingPeriods_Module.deleteRow(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/ClosingPeriods/Index" }, 3000);
                        } else
                            setTimeout(function () { window.location = "/ClosingPeriods/CreateEdit" }, 3000);

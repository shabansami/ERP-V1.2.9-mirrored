...
var ContractAttendanceLeaving_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                ...
                {
                    "extend": "excelHtml5",
                    "filename": "حضور وانصراف الموظفين",
            ...
            ajax: {
                url: '/ContractAttendanceLeavings/GetAll',
                type: 'GET',
            ...
            columns: [
                ...
                { data: 'AttendanceLeavingDate', title: 'اليوم' },
                { data: 'MonthYear', title: 'شهر/اسبوع/يوم' },
                { data: 'AttendanceTime', title: 'وقت الحضور' },
                { data: 'LeavingTime', title: 'وقت الانصراف' },
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        return '\
							<div class="btn-group">\
                            	<a href="/ContractAttendanceLeavings/Edit/'+ row.Id + '" class="btn btn-sm btn-clean btn-icon" title="تعديل">\
								<i class="la la-edit"></i>\
							</a>\
							<a href="javascript:;" onclick=ContractAttendanceLeaving_Module.deleteRow(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/ContractAttendanceLeavings/Index" }, 3000);
                        } else
                            setTimeout(function () { window.location = "/ContractAttendanceLeavings/CreateEdit" }, 3000);
    ...
    function deleteRow(id) {
        Swal.fire({
            ...
            if (result.value) {
                var url = '/ContractAttendanceLeavings/Delete';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {

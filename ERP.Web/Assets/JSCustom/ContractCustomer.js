...
var ContractCustomer_Module = function () {
    var initDT = function () {
            ...
            buttons: [
                {
                    ...
                    title: function () {
                        ...
                        var div="<div style='color:black;' >مدة استحقاق السداد</div>"
                        return div;
                    },
                ...
                {
                    "extend": "excelHtml5",
                    "filename": "مدة استحقاق السداد",
                    "title": "مدة استحقاق السداد",
                exportOptions: {
                    columns: ':visible'
                }
                },
        ...
        columns: [
            ...
            { data: 'DayCount', title: 'عدد الايام'},
                ...
                },
            {
                ...
                render: function (data, type, row, meta) {
                                return `
							<div class="btn-group">
                                <a href="/ContractCustomers/Edit/`+ row.Id + `" class="btn btn-sm btn-clean btn-icon" title="تعديل">\
								<i class="fa fa-edit"></i>\
							</a>
							<a href="javascript:;" onclick=ContractCustomer_Module.deleteRow('`+ row.Id + `') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
...
//"order": [[0, "desc"]] 
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/ContractCustomers/Index" }, 3000);
                        }else
                            setTimeout(function () { window.location = "/ContractCustomers/CreateEdit" } , 3000);
    ...
    function deleteRow(id) {
        Swal.fire({
            ...
            if (result.value) {
                var url = '/ContractCustomers/Delete';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {

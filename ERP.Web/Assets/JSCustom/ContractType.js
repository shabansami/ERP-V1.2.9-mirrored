...
var ContractType_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                ...
                {
                    "extend": "excelHtml5",
                    "filename": "انواع التعاقدات",
                    "title": "انواع التعاقدات",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
            ...
            ajax: {
                url: '/ContractTypes/GetAll',
                type: 'GET',

            },
            columns: [
                { data: 'Num', responsivePriority: 0 },
                { data: 'Name', title: 'نوع العقد' },
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        return '\
							<div class="btn-group">\
							<a href="/ContractTypes/Edit/'+ row.Id + '" class="btn btn-sm btn-clean btn-icon" title="تعديل">\
								<i class="fa fa-edit"></i>\
							</a>\
							<a href="javascript:;" onclick=ContractType_Module.deleteRow(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/ContractTypes/Index" }, 3000);
                        } else
                            setTimeout(function () { window.location = "/ContractTypes/CreateEdit" }, 3000);

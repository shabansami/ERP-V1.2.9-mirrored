...
var CustomerIntialBalance_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            ajax: {
                url: '/CustomerIntialBalances/GetAll',
                type: 'GET',
        ...
        columns: [
                ...
                },
            {
                ...
                render: function (data, type, row, meta) {
                                return '\
							<div class="btn-group">\
							<a href="javascript:;" onclick=CustomerIntialBalance_Module.deleteRow('+ row.TransactionId + ') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
...
//"order": [[0, "desc"]] 
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/CustomerIntialBalances/Index" }, 3000);
                        }else
                            setTimeout(function () { window.location = "/CustomerIntialBalances/CreateEdit" } , 3000);
    ...
    function deleteRow(id) {
        Swal.fire({
            ...
            if (result.value) {
                var url = '/CustomerIntialBalances/Delete';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {

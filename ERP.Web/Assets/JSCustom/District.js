    ...
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                {
                    ...
                    title: function () {
                        ...
                        var div = "<div style='color:black;' >الاحياء</div>"
                        return div;
                    },
            ...
            columns: [
                ...
                { data: 'RegionName', title: 'المنطقة' },
                { data: 'Name', title: 'الحي' },
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        return '\
							<div class="btn-group">\
							<a href="/Districts/Edit/'+ row.Id + '" class="btn btn-sm btn-clean btn-icon" title="تعديل">\
								<i class="fa fa-edit"></i>\
							</a>\
							<a href="javascript:;" onclick=District_Module.deleteRow(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/Districts/Index" }, 3000);
                        } else
                            setTimeout(function () { window.location = "/Districts/CreateEdit" }, 3000);

    ...
    var initDT = function () {
        ...
        table.DataTable({
            ...
            columns: [
                ...
                { data: 'Name', title: 'اسم الموظف' },
                { data: 'Tel', title: 'رقم التليفون' },
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        return '\
							<div class="btn-group">\
							<a href="/Employees/Edit/'+ row.Id + '" class="btn btn-sm btn-clean btn-icon" title="تعديل">\
								<i class="fa fa-edit"></i>\
							</a>\
							<a href="javascript:;" onclick=Employee_Module.deleteRow(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/Employees/Index" }, 3000);
                        } else
                            setTimeout(function () { window.location = "/Employees/CreateEdit" }, 3000);

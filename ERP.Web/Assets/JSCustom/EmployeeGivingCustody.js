...
var EmployeeGivingCustody_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                ...
                {
                    "extend": "excelHtml5",
                    "filename": "صرف عهدة لموظف",
                    "title": "صرف عهدة لموظف",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
            ...
            ajax: {
                url: '/EmployeeGivingCustody/GetAll',
                type: 'GET',
        ...
        columns: [
            ...
            { data: 'Amount', title: 'قيمة العهدة' },
            { data: 'CustodyDate', title: 'تاريخ صرف العهدة' },
...
//"order": [[0, "desc"]] 
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        toastr.success(res.message, '',)
                            setTimeout(function () { window.location = "/EmployeeGivingCustody/CreateEdit" } , 3000);
    ...
    function deleteRow(id) {
        Swal.fire({
            ...
            if (result.value) {
                var url = '/EmployeeGivingCustody/Delete';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {
    ...
    function ApprovalCustody(id) {
        Swal.fire({
            ...
            if (result.value) {
                var url = '/EmployeeGivingCustody/ApprovalCustody';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {

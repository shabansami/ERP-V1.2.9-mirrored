...
var EmployeeReturnCustody_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                ...
                {
                    extend: "excelHtml5",
                    filename: "مصروف عهدة لموظف",
                    title: "مصروف عهدة لموظف",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
            ...
            ajax: {
                url: '/EmployeeReturnCustody/GetAll',
                type: 'GET',
...
//"order": [[0, "desc"]] 
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        toastr.success(res.message, '',)
                            setTimeout(function () { window.location = "/EmployeeReturnCustody/CreateEdit" } , 3000);
    ...
    function deleteRow(id) {
        Swal.fire({
            ...
            if (result.value) {
                var url = '/EmployeeReturnCustody/Delete';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {
    ...
    function ApprovalCustody(id) {
        Swal.fire({
            title: 'تأكيد اعتماد مصروف العٌهدة',
            ...
            if (result.value) {
                var url = '/EmployeeReturnCustody/ApprovalCustody';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {

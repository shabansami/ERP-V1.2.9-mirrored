...
var ItemType_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            ajax: {
                url: '/ItemTypes/GetAll',
                type: 'GET',

                    },
        columns: [
            { data: 'Num',responsivePriority:0 },
            { data: 'Name', title: 'نوع الصنف' },
                ...
                },
            {
                ...
                render: function (data, type, row, meta) {
                                return '\
							<div class="btn-group">\
							<a href="/ItemTypes/Edit/'+ row.Id + '" class="btn btn-sm btn-clean btn-icon" title="تعديل">\
								<i class="fa fa-edit"></i>\
							</a>\
							<a href="javascript:;" onclick=ItemType_Module.deleteRow(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/ItemTypes/Index" }, 3000);
                        }else
                            setTimeout(function () { window.location = "/ItemTypes/CreateEdit" } , 3000);

		...
		_wizard.on('beforeNext', function (wizard) {
			...
			validator.validate().then(function (status) {
				if (status == 'Valid') {
					...
					Swal.fire({
						text: "للاسف..يوجد بعض الاخطاء تم اكتشافها ..حاول مرة آخرى",
						icon: "error",

...
var PurchaseBackInvoiceStore_Module = function () {
    ...
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                {
                    extend: 'print',
                    title: function () {
                        return 'الاعتماد المخزنى لفواتير مرتجع التوريد';
                    },
                ...
                {
                    extend: "excelHtml5",
                    filename: "الاعتماد المخزنى لفواتير مرتجع التوريد",
                    title: "الاعتماد المخزنى لفواتير مرتجع التوريد",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
            ...
            ajax: {
                url: '/PurchaseBackInvoiceStores/GetAll',
                type: 'GET',
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                if (params.has('invoGuid')) {
                    ...
                    document.location.replace("PurchaseBackInvoiceStores/Index")

                var url = '/PurchaseBackInvoiceStores/ApprovalInvoice';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {
                    ...
                    success: function (data) {
                        if (data.isValid) {
                            ...
                            setTimeout(function () { window.location = "/PurchaseBackInvoiceStores/Index" }, 3000);
                        } else {

...
var PurchaseInvoiceAccounting_Module = function () {
    ...
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                {
                    extend: 'print',
                    title: function () {
                        return 'الاعتماد المحاسبى لفواتير التوريد';
                    },
                ...
                {
                    extend: "excelHtml5",
                    filename: "الاعتماد المحاسبى لفواتير التوريد",
                    title: "الاعتماد المحاسبى لفواتير التوريد",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
            ...
            ajax: {
                url: '/PurchaseInvoiceAccounting/GetAll',
                type: 'GET',
...
//"order": [[0, "desc"]] 
    ...
    function ApprovalInvoice(invoGuid) { // اعتماد فاتورة محاسبيا
        Swal.fire({
            ...
            if (result.value) {
                var url = '/PurchaseInvoiceAccounting/ApprovalInvoice';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {

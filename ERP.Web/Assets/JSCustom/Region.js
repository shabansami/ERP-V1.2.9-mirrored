            ...
            buttons: [
                {
                    ...
                    title: function () {
                        ...
                        var div = "<div style='color:black;' >المناطق</div>"
                        return div;
                    },
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        return '\
							<div class="btn-group">\
							<a href="/Regions/Edit/'+ row.Id + '" class="btn btn-sm btn-clean btn-icon" title="تعديل">\
								<i class="fa fa-edit"></i>\
							</a>\
							<a href="javascript:;" onclick=Region_Module.deleteRow(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/Regions/Index" }, 3000);
                        } else
                            setTimeout(function () { window.location = "/Regions/CreateEdit" }, 3000);

            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        return '\
							<div class="btn-group">\
							<a href="/Safes/Edit/'+ row.Id + '" class="btn btn-sm btn-clean btn-icon" title="تعديل">\
								<i class="la la-edit"></i>\
							</a>\
							<a href="javascript:;" onclick=Safe_Module.deleteRow(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/Safes/Index" }, 3000);
                        } else
                            setTimeout(function () { window.location = "/Safes/CreateEdit" }, 3000);

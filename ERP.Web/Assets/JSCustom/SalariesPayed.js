...
var SalariesPayed_Module = function () {
    var initDT = function () {
    ...
    function SalaryPaid(id,elem) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                var url = '/SalariesPayed/SalaryPaid';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {
                    ...
                    success: function (data) {
                        if (data.isValid) {
                            ...
                            $(elem).remove();
                            //setTimeout(function () { window.location = "/SalariesPayed/Index" }, 3000);
                        } else {

...
var SaleMenStore_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                ...
                {
                    extend: "excelHtml5",
                    filename: "مخازن المناديب",
                    title: "مخازن المناديب",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/SaleMenStores/Index" }, 3000);
                        }else
                            setTimeout(function () { window.location = "/SaleMenStores/CreateEdit" } , 3000);

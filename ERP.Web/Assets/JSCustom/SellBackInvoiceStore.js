...
var SellBackInvoiceStore_Module = function () {
    ...
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                {
                    extend: 'print',
                    title: function () {
                        return 'الاعتماد المخزنى لفواتير مرتجع البيع';
                    },
                ...
                {
                    extend: "excelHtml5",
                    filename: "الاعتماد المخزنى لفواتير مرتجع البيع",
                    title: "الاعتماد المخزنى لفواتير مرتجع البيع",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
            ...
            ajax: {
                url: '/SellBackInvoiceStores/GetAll',
                type: 'GET',
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                if (params.has('invoGuid')) {
                    ...
                    document.location.replace("SellBackInvoiceStores/Index")

                var url = '/SellBackInvoiceStores/ApprovalInvoice';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {
                    ...
                    success: function (data) {
                        if (data.isValid) {
                            ...
                            setTimeout(function () { window.location = "/SellBackInvoiceStores/Index" }, 3000);
                        } else {

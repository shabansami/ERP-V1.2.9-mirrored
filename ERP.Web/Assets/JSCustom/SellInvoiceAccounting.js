...
var SellInvoiceAccounting_Module = function () {
    ...
    var initDT = function () {
        ...
        table.DataTable({
            ...
            buttons: [
                {
                    extend: 'print',
                    title: function () {
                        return 'الاعتماد المحاسبى لفواتير البيع';
                    },
                ...
                {
                    extend: "excelHtml5",
                    filename: "الاعتماد المحاسبى لفواتير البيع",
                    title: "الاعتماد المحاسبى لفواتير البيع",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
            ...
            ajax: {
                url: '/SellInvoiceAccounting/GetAll',
                type: 'GET',
                ...
                render: function (data, type, row, meta) {
                    if (row.IsApprovalAccountant) {
                       ...
                       return '\
						...
						<a href="javascript:;" onclick=SellInvoiceAccounting_Module.ApprovalInvoice(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="اعتماد الفاتورة محاسبيا">\
...
//"order": [[0, "desc"]] 
    ...
    function ApprovalInvoice(invoGuid) { // اعتماد فاتورة محاسبيا
        Swal.fire({
            ...
            if (result.value) {
                var url = '/SellInvoiceAccounting/ApprovalInvoice';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {

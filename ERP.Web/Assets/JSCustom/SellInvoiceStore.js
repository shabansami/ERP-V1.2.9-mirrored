...
var SellInvoiceStore_Module = function () {
            ...
            buttons: [
                {
                    extend: 'print',
                    title: function () {
                        return 'الاعتماد المخزنى لفواتير البيع';
                    },
                ...
                {
                    extend: "excelHtml5",
                    filename: "الاعتماد المخزنى لفواتير البيع",
                    title: "الاعتماد المخزنى لفواتير البيع",
                    exportOptions: {
                        columns: ':visible'
                    }
                },
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                if (params.has('invoGuid')) {
                    ...
                    document.location.replace("SellInvoiceStores/Index")

                var url = '/SellInvoiceStores/ApprovalInvoice';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {
                    ...
                    success: function (data) {
                        if (data.isValid) {
                            ...
                            setTimeout(function () { window.location = "/SellInvoiceStores/Index" }, 3000);
                        } else {

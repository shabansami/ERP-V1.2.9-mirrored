    ...
    var initDT = function () {
        ...
        table.DataTable({
            ...
            columns: [
                ...
                { data: 'WorkingPeriodName', title: 'الفترة' },
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                            ...
                            return '\
							<div class="btn-group">\
							<a href="/Shifts/Edit/'+ row.Id + '" class="btn btn-sm btn-clean btn-icon"  title="تعديل">\
								<i class="fa fa-edit"></i>\
							</a>\
                            <a href="javascript:;" onclick=Shift_Module.deleteRow(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="حذف">\
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/Shifts/Index" }, 3000);
                        } else
                            setTimeout(function () { window.location = "/Shifts/CreateEdit" }, 3000);

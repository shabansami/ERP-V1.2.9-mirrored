"use strict";
var SupplierIntialBalance_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            ajax: {
                url: '/SupplierIntialBalances/GetAll',
                type: 'GET',
...
//"order": [[0, "desc"]] 
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/SupplierIntialBalances/Index" }, 3000);
                        }else
                            setTimeout(function () { window.location = "/SupplierIntialBalances/CreateEdit" } , 3000);
    ...
    function deleteRow(id) {
        Swal.fire({
            ...
            if (result.value) {
                var url = '/SupplierIntialBalances/Delete';
                $.ajax({
                    type: "POST",
                    url: url,
                    data: {

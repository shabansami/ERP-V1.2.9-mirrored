...
var VacationDay_Module = function () {
    var initDT = function () {
        ...
        table.DataTable({
            ...
            columns: [
                ...
                { data: 'DayName', title: 'اليوم' },
                { data: 'DateFrom', title: 'التاريخ من' },
                { data: 'DateTo', title: 'التاريخ الى' },
                { data: 'IsWeekly', title: 'الحالة' },
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.isValid) {
                        ...
                        if (!res.isInsert) {
                            setTimeout(function () { window.location = "/VacationDays/Index" }, 3000);
                        } else
                            setTimeout(function () { window.location = "/VacationDays/CreateEdit" }, 3000);
    ...
    function onIsWeeklyChange() {
        if ($("#cmboStatus option:checked").val() === "1") {
            $('#IsWeekly').val(true);
            $('#divWeekly').show();
            $('#divYearly').hide();
        } else if ($("#cmboStatus option:checked").val() === "2") {
            $('#IsWeekly').val(false);
            $('#divWeekly').hide();
            $('#divYearly').show();
        } else {
    ...
    return {
        ...
        onIsWeeklyChange: onIsWeeklyChange
    };

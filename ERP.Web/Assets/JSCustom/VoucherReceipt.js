                    ...
                    render: function (data, type, row, meta) {
						...
						';
                            ...
                            <span class="label label-lg font-weight-bold label-light-success label-inline">تم اعتمادها</span><a href="javascript:;" onclick=VoucherReceipt_Module.UnApproval(\''+ row.Id + '\') class="btn btn-sm btn-clean btn-icUrln" title="فك الاعتماد">\
								<i class="la la-check-square-o"></i>\<a href="/GeneralDailies/Index/?tranId='+ row.Id + '&tranTypeId=23" class="btn btn-sm btn-clean btn-icon" title="عرض القيود">\
								<i class="la la-money"></i></a><a href="javascript:;" onclick="PrintInvoice_Module.PrintPayment(\''+ row.Id + '\',\'voucherReceipt\');" class="btn btn-sm btn-clean btn-icUrln" title="طباعه ايصال">\

    ...
    public class PurchaseBackInvoicesController : Controller
    {
        ...
        public ActionResult CreateEdit()
        {
            ...
            {                   // add
                ...
                ViewBag.StoreId = new SelectList(stores, "Id", "Name", branchId);
        ...
        [HttpGet]
        public ActionResult SaveCopiedInvoice()
        {
        ...
        [HttpPost]
        public JsonResult SaveCopiedInvoice(PurchaseBackInvoice vm, string DT_DatasourceItems, string DT_DatasourceExpenses)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult UnApproval(string invoGuid)
        {
            ...
            if (Guid.TryParse(invoGuid, out Id))
            {
                ...
                if (model != null)
                {
                    ...
                    foreach (var item in model.PurchaseBackInvoicesDetails.Where(x => !x.IsDeleted))
                    {

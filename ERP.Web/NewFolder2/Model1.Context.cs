...
namespace ERP.Web.NewFolder2
{
    ...
    public partial class sc_clientsDb2Entities : DbContext
    {
        public sc_clientsDb2Entities()
            : base("name=sc_clientsDb2Entities")
        {
        }
        ...
        public virtual DbSet<BalanceFirstDuration> BalanceFirstDurations { get; set; }
        ...
        public virtual DbSet<ScalarValueFunction> ScalarValueFunctions { get; set; }
        ...
        public virtual DbSet<OldDataaaa> OldDataaaas { get; set; }
    }
}

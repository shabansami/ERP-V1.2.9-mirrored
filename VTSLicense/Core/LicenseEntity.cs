...
namespace VTSLicense.Core
{
    ...
    public class ShowInLicenseInfoAttribute : Attribute
    {
        ...
        {
            if (showInLicenseInfo) throw new Exception("When ShowInLicenseInfo is True, DisplayAs MUST have a value");
        ...
        public bool ShowInLicenseInfo => _showInLicenseInfo;

        public string DisplayAs => _displayAs;

        public FormatType DataFormatType => _formatType;
    }
    ...
    public abstract class LicenseEntity
    {
        ...
        [ShowInLicenseInfo(true, "Expire Time", ShowInLicenseInfoAttribute.FormatType.DateTime)]
        ...
        /// <returns></returns>
        public abstract LicenseStatus ValidateAppName(out string validationMsg);
    }
}
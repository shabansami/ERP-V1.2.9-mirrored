...
namespace VTSLicense.LicenseChecker.UI.UserControls
{
    partial class LicenseSettingsControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.grpbxLicenseType.Controls.Add(this.dtpExpirationDate);
            this.grpbxLicenseType.Controls.Add(this.rbExpiration);
            ...
            // rbExpiration
            // 
            resources.ApplyResources(this.rbExpiration, "rbExpiration");
            this.rbExpiration.Name = "rbExpiration";
            this.rbExpiration.UseVisualStyleBackColor = true;
            this.rbExpiration.CheckedChanged += new System.EventHandler(this.LicenseTypeRadioButtons_CheckedChanged);
            // 
            // dtpExpirationDate
            // 
            resources.ApplyResources(this.dtpExpirationDate, "dtpExpirationDate");
